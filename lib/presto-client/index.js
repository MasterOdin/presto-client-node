...
var Client = exports.Client = function(args){
    ...
    this.timeout = args.timeout != null ? args.timeout : 60;
...
Client.prototype.request = function(opts, callback) {
    ...
    var req = adapter.request(opts, function(res){
        ...
        res.on('end', function(){
            ...
            var error = new Error('execution error: could not parse response');;
            // Only a 200 response code should be considered successful
            if (response_code === 200 && (data[0] === '{' || data[0] === '[')) {
                try {
...
Client.prototype.statementResource = function(opts) {
    ...
    var timeout_value = opts.timeout != null ? opts.timeout : this.timeout;
    ...
    */
    ...
    var fetch_next = function(next_uri){
        ...
        else if (!first_request && cancel_checker && cancel_checker()) {
        ...
        current_req = client.request(next_uri, function(error, code, response){
            ...
            if (timed_out) {
                ...
                return;
            } else if (error || (response && response.error)) {
                if (first_request) {
    ...
    fetch_next({ method: 'POST', path: '/v1/statement', headers: header, body: opts.query, user: opts.user });
};
